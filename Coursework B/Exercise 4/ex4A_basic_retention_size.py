...
def grade(pop, target, bestFitness, best_individual):
    ...
    highest_fitness = min(fitnessList)
    
    return summed, best_individual, bestFitness, list_mode, highest_fitness
...
for x in range(iterations):
    ...
    retension_size = varying_parameter
    print(varying_parameter)
    pop_R = pop_orig
    fitness_history_R = []
    mode_history_R = []
    best_fitness_R = []
    population_fitness, best_individual, best_fitness, fitness_mode, highest_fitness = grade( pop_orig , target, best_fitness, best_individual)
    ...
    for y in range(generations):
        pop_R = evolve( pop_R , target, fitness_history_R[y-1], type, elitism, 1, retain= retension_size)
        population_fitness, best_individual, best_fitness, fitness_mode, highest_fitness = grade( pop_R, target, best_fitness, best_individual)
...
plt.title("Fitness vs Retention Size")
plt.xlabel("Retension Size")
