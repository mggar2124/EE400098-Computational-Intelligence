...
def fitness(individual, y_coordinate, x_coordinate):
    ...
    for x in range(len(x_coordinate)):                         
        y_output = polynomial_comp(x_coordinate[x], individual)     #
...
for x in range(iterations):
    ...
    for y in range(generations):
        pRU = evolve( pRU , y_coordinate_list, x_coordinate_list, fitness_history_RU[y-1], evolve_type= 0, elitism= 0, crossover= 3)
        ...
        # if fitness_modal <= 10000 and stop != 0:
        #     print("arrived")
